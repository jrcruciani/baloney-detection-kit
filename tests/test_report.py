...
class TestGenerateReport:
    def test_includes_header(self):
        ...
        assert "# BDK Behavioral Diagnostic Report" in report
...
class TestGenerateJsonReport:
    ...
    def test_includes_coherence_data(self):
        from bdk.coherence import CoherenceReport
    ...
    def test_includes_score_data(self):
        from bdk.scoring import DiagnosticScore, DiagnosticSupportProfile, HypothesisSupport
