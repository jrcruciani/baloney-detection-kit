"""Unit tests for validation/diagnosis/reproducible/run_case.py aggregation helpers.
...
# Load the module by path because validation/diagnosis/reproducible/ is not a package.
_ROOT = Path(__file__).resolve().parents[1]
_RUN_CASE_PATH = _ROOT / "validation" / "diagnosis" / "reproducible" / "run_case.py"
