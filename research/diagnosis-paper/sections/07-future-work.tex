...
The work in this paper is the first reproducible release of BDK diagnostics.
Several threads are explicit in the repository's issue
...
The current taxonomy (\texttt{framework/diagnosis/taxonomy.md}) enumerates a handful of
