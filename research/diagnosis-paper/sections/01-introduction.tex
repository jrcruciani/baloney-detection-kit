...
\paragraph{BDK diagnostics.}
We introduce the diagnostic layer of the \emph{Baloney Detection Kit} (BDK), a
behavioral toolkit
...
positions BDK diagnostics against benchmarks, red teaming, alignment evals,
