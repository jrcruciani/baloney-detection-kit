...
The BDK diagnostic method rests on five rules. The rules and the rest
of the method are described informally in the repository's
\texttt{framework/diagnosis/guide.md} and \texttt{framework/diagnosis/method.md}; this section formalizes them
for citation.
...
The repository's \texttt{framework/diagnosis/taxonomy.md} document enumerates the
...
diagnostic entry point in the decision flowchart of \texttt{framework/diagnosis/method.md}.
