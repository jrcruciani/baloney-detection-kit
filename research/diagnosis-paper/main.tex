% Workshop preprint draft — Baloney Detection Kit: behavioral diagnostics for AI.
% Issue: https://github.com/jrcruciani/baloney-detection-kit/issues/11
%
...
\title{Baloney Detection Kit: Behavioral Diagnostics for AI \\
       \large A Practitioner Toolkit for Post-hoc, User-side Interpretation}

\author{JR Cruciani \\
        \texttt{jrcruciani@gmail.com} \\
        \url{https://github.com/jrcruciani/baloney-detection-kit}}
...
\begin{abstract}
We present the diagnostic layer of the \emph{Baloney Detection Kit} (BDK), a
behavioral toolkit for
...
\appendix
\input{appendix/A-prompts}
\input{appendix/B-case-transcripts}
\input{appendix/C-code-snippets}
