...
4. **Run one prompt card.** Copy the card's source prompt from
   [`guide.md`](guide.md) or
   [`../../prompts/diagnosis/catalog.yaml`](../../prompts/diagnosis/catalog.yaml).
...
7. **Record the human judgment.** Use
   [`../../templates/diagnosis/incident-diagnosis.md`](../../templates/diagnosis/incident-diagnosis.md).
...
[`../../templates/diagnosis/ratchet-transcript.md`](../../templates/diagnosis/ratchet-transcript.md).
