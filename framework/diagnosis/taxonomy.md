...
> **v3.0 automation:** After manual diagnosis, use `bdk crosscheck` for automated A/B behavioral verification, `bdk coherence` to validate post-ratchet consistency, and `bdk score` for quantitative rubric scoring.
...
*Part of Baloney Detection Kit by JR Cruciani.*
