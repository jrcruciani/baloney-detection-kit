...
``validation/diagnosis/reproducible/case-03-ratchet-coherence/artifacts/session.json``
...
from bdk.coherence_llm import (  # noqa: E402
    LLMCoherenceReport,
    analyze_coherence_llm,
)
from bdk.engine import DiagnosticEngine, DiagnosticStep  # noqa: E402
from bdk.providers import (  # noqa: E402
    Provider,
    create_provider,
)
from bdk.security import (  # noqa: E402
    private_write_text,
    redact_secrets,
...
def coherence_report_to_json(
    ...
    Kept in sync with the schema used by validation/diagnosis/reproducible/run_case.py
